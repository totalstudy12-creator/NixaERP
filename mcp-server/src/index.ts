...
import {
  handleAuthorize,
} from './oauth/authorize-handler.js';

import {
  handleLogin,
} from './oauth/login-handler.js';

import {
  handleConsent,
} from './oauth/consent-handler.js';

import {
  handleToken,
} from './oauth/token-handler.js';
...
/*
|--------------------------------------------------------------------------
| Authorization Result -> Node Response
|--------------------------------------------------------------------------
*/
...
server.once(
  ...
  () => {
    ...
    console.log(
      `MCP:              ${config.mcpPublicUrl}${MCP_PATH}`,
    );

    console.log(
      `Health:           ${config.mcpPublicUrl}${HEALTH_PATH}`,
    );

    console.log(
      `Protected:        ${config.mcpPublicUrl}${PROTECTED_RESOURCE_METADATA_PATH}`,
    );

    console.log(
      `OAuth Metadata:   ${config.mcpPublicUrl}${AUTHORIZATION_SERVER_METADATA_PATH}`,
    );

    console.log(
      `OAuth Authorize:  ${config.mcpPublicUrl}${AUTHORIZE_PATH}`,
    );

    console.log(
      `OAuth Login:      ${config.mcpPublicUrl}${LOGIN_PATH}`,
    );

    console.log(
      `OAuth Consent:    ${config.mcpPublicUrl}${CONSENT_PATH}`,
    );

    console.log(
      `OAuth Token:      ${config.mcpPublicUrl}${TOKEN_PATH}`,
    );
