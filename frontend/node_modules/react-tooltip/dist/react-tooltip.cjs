...
const TooltipController = React.forwardRef(({ id, anchorSelect, content, render, className, classNameArrow, variant = 'dark', portalRoot, place = 'top', offset = 10, wrapper = 'div', children = null, openOnClick = false, positionStrategy = 'absolute', middlewares, delayShow = 0, delayHide = 0, autoClose, float = false, hidden = false, noArrow = false, clickable = false, openEvents, closeEvents, globalCloseEvents, imperativeModeOnly = false, style, position, isOpen, defaultIsOpen = false, disableStyleInjection = false, border, opacity, arrowColor, arrowSize, setIsOpen, afterShow, afterHide, disableTooltip, role = 'tooltip', }, ref) => {
     ...
     */
    const tooltipContent = (_a = currentAnchorDataAttributes.content) !== null && _a !== void 0 ? _a : content;
    const tooltipPlace = (_b = currentAnchorDataAttributes.place) !== null && _b !== void 0 ? _b : place;
    const tooltipVariant = (_c = currentAnchorDataAttributes.variant) !== null && _c !== void 0 ? _c : variant;
    const tooltipOffset = currentAnchorDataAttributes.offset == null
        ? offset
        : Number(currentAnchorDataAttributes.offset);
    const tooltipWrapper = (_d = currentAnchorDataAttributes.wrapper) !== null && _d !== void 0 ? _d : wrapper;
    const tooltipPositionStrategy = (_e = currentAnchorDataAttributes['position-strategy']) !== null && _e !== void 0 ? _e : positionStrategy;
    const tooltipDelayShow = currentAnchorDataAttributes['delay-show'] == null
        ? delayShow
        : Number(currentAnchorDataAttributes['delay-show']);
    const tooltipDelayHide = currentAnchorDataAttributes['delay-hide'] == null
        ? delayHide
        : Number(currentAnchorDataAttributes['delay-hide']);
    const tooltipAutoClose = currentAnchorDataAttributes['auto-close'] == null
        ? autoClose
        : Number(currentAnchorDataAttributes['auto-close']);
    const tooltipFloat = currentAnchorDataAttributes.float == null
        ? float
        : currentAnchorDataAttributes.float === 'true';
    const tooltipHidden = currentAnchorDataAttributes.hidden == null
        ? hidden
        : currentAnchorDataAttributes.hidden === 'true';
    const tooltipClassName = (_f = currentAnchorDataAttributes['class-name']) !== null && _f !== void 0 ? _f : null;
    let renderedContent = children;
    const contentWrapperRef = React.useRef(null);
    if (render) {
        const actualContent = (_h = (_g = currentAnchorDataAttributes.content) !== null && _g !== void 0 ? _g : tooltipContent) !== null && _h !== void 0 ? _h : null;
