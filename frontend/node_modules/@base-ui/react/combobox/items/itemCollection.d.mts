...
import { type ItemEqualityComparer } from "../../internals/itemEquality.mjs";
export declare function findCollectionItem<Item, Value>(valueToItem: Map<Value, Item>, itemValue: Value, isEqual: ItemEqualityComparer<Value>): Item | undefined;
/**
