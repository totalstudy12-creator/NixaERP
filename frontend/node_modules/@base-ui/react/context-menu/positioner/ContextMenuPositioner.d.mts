...
import { type MenuPositionerProps, type MenuPositionerState } from "../../menu/positioner/MenuPositioner.mjs";
 ...
 */
export declare const ContextMenuPositioner: React.ForwardRefExoticComponent<ContextMenuPositionerProps & React.RefAttributes<HTMLDivElement>>;
export interface ContextMenuPositionerProps extends Omit<MenuPositionerProps, keyof BaseUIComponentProps<'div', ContextMenuPositionerState> | 'anchor' | 'positionMethod' | 'side' | 'sideOffset' | 'align' | 'alignOffset' | 'arrowPadding'>, BaseUIComponentProps<'div', ContextMenuPositionerState> {
  /**
...
export declare namespace ContextMenuPositioner {
