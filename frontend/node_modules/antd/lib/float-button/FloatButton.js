...
const InternalFloatButton = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const [mergedClassNames, mergedStyles] = (0, _useMergeSemantic.useMergeSemantic)([floatButtonClassNames, contextClassNames, classNames], [contextStyles, styles], {
    props: mergedProps
  });
  // ============================= Icon =============================
  const mergedIcon = !(0, _is.isReactRenderable)(mergedContent) && !icon ? /*#__PURE__*/_react.default.createElement(_FileTextOutlined.default, null) : icon;
  // ============================ zIndex ============================
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    process.env.NODE_ENV !== "production" ? warning(!(mergedShape === 'circle' && (0, _is.isReactRenderable)(mergedContent)), 'usage', 'supported only when `shape` is `square`. Due to narrow space for text, short sentence is recommended.') : void 0;
  ...
  let node = /*#__PURE__*/_react.default.createElement(_Button.default, {
    ...
    className: (0, _clsx.clsx)(hashId, cssVarCls, rootCls, prefixCls, className, rootClassName, `${prefixCls}-${type}`, `${prefixCls}-${mergedShape}`, {
      ...
      [`${prefixCls}-icon-only`]: !(0, _is.isReactRenderable)(mergedContent)
    }),
