...
const InternalTag = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  const [, mergedCloseIcon] = (0, _hooks.useClosable)((0, _hooks.pickClosable)(props), (0, _hooks.pickClosable)(tagContext), {
    ...
    closeIconRender: iconNode => {
      const replacement = /*#__PURE__*/React.createElement("span", {
        ...
        className: (0, _clsx.clsx)(`${prefixCls}-close-icon`, mergedClassNames.close),
      ...
      return (0, _reactNode.replaceElement)(iconNode, replacement, originProps => ({
        ...
        tabIndex: mergedDisabled ? -1 : 0,
        'aria-disabled': mergedDisabled || undefined,
        className: (0, _clsx.clsx)(originProps?.className, `${prefixCls}-close-icon`, mergedClassNames.close),
        style: {
          ...mergedStyles.close,
          ...originProps?.style
        }
  ...
  // ====================== Render ======================
  const isNeedWave = (0, _is.isFunction)(restProps.onClick) || children && children.type === 'a';
  const iconNode = (0, _reactNode.cloneElement)(icon, {
    className: (0, _clsx.clsx)(/*#__PURE__*/React.isValidElement(icon) ? icon.props?.className : undefined, mergedClassNames.icon),
    style: mergedStyles.icon
  });
  const child = iconNode ? (/*#__PURE__*/React.createElement(React.Fragment, null, iconNode, (0, _is.isReactRenderable)(children) && (/*#__PURE__*/React.createElement("span", {
