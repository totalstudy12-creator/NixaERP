...
const CardMeta = /*#__PURE__*/React.forwardRef((props, ref) => {
  const {
  ...
  const [mergedClassNames, mergedStyles] = (0, _useMergeSemantic.useMergeSemantic)([contextClassNames, cardMetaClassNames], [contextStyles, contextStyleRoot, styles, styleRoot], {
    props
  });
  ...
  const avatarDom = (0, _is.isReactRenderable)(avatar) ? (/*#__PURE__*/React.createElement("div", {
    className: avatarClassNames,
    style: mergedStyles.avatar
  }, avatar)) : null;
  const titleDom = (0, _is.isReactRenderable)(title) ? (/*#__PURE__*/React.createElement("div", {
    className: titleClassNames,
    style: mergedStyles.title
  }, title)) : null;
  const descriptionDom = (0, _is.isReactRenderable)(description) ? (/*#__PURE__*/React.createElement("div", {
