import { i as __toCommonJS, n as __esmMin, r as __exportAll, t as __commonJSMin } from "./rolldown-runtime-7_rZTKki.js";
import { t as require_react } from "./react.js";
import { t as require_prop_types } from "./prop-types-D1Q50vvl.js";
import { E as merge, I as Adder, S as init_src$9, a as zoom_default$1, b as color, c as interpolateTransformSvg, g as number_default, m as string_default, s as interpolateTransformCss, t as init_src$11, v as rgb_default, w as range_default, y as init_src$10 } from "./src-BBUUhIPp.js";
...
function circle_default$1() {
	var center = constant_default$2([0, 0]), radius = constant_default$2(90), precision = constant_default$2(6), ring, rotate, stream = { point };
	function point(x, y) {
...
function distance_default(a, b) {
	coordinates[0] = a;
	coordinates[1] = b;
	return length_default(object$1);
}
var coordinates, object$1;
...
var init_interpolate$1 = __esmMin((() => {
	init_math();
}));
//#endregion
//#region node_modules/d3-geo/src/identity.js
var identity_default$2;
var init_identity$2 = __esmMin((() => {
	identity_default$2 = (x) => x;
}));
//#endregion
...
function path_default(projection, context) {
	...
	path.projection = function(_) {
		return arguments.length ? (projectionStream = _ == null ? (projection = null, identity_default$2) : (projection = _).stream, path) : projection;
	};
...
function transform_default$1(methods) {
...
var src_exports$3 = /* @__PURE__ */ __exportAll({
	...
	geoIdentity: () => identity_default$1,
	geoInterpolate: () => interpolate_default$1,
	...
	geoTransform: () => transform_default$1,
	...
	function bboxGeometry(o) {
		switch (o.type) {
			...
			case "Point":
				...
				break;
			case "MultiPoint": o.coordinates.forEach(bboxPoint);
		}
	}
...
function merge_default$2(topology) {
...
function merge_default$1(selection) {
...
function create_default(name) {
	return select_default$1(creator_default(name).call(document.documentElement));
}
...
function selectAll_default$1(selector) {
	return typeof selector === "string" ? new Selection$1([document.querySelectorAll(selector)], [document.documentElement]) : new Selection$1([selector == null ? [] : array_default(selector)], root);
}
...
function nodrag_default(view) {
	var root = view.document.documentElement, selection = select_default$1(view).on("dragstart.drag", noevent_default$1, true);
...
function zoom_default() {
	...
	function mousedowned(event, ...args) {
		...
		var g = gesture(this, args, true).event(event), v = select_default$1(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default(event, currentTarget), currentTarget = event.currentTarget, x0 = event.clientX, y0 = event.clientY;
...
var require_index_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		"object" == typeof exports && "undefined" != typeof module ? t(exports, require_react(), require_prop_types(), (init_src$8(), __toCommonJS(src_exports$3)), (init_src$7(), __toCommonJS(src_exports$2)), (init_src(), __toCommonJS(src_exports)), (init_src$5(), __toCommonJS(src_exports$1))) : "function" == typeof define && define.amd ? define([
			"exports",
			"react",
			"prop-types",
			"d3-geo",
		...
		function I(e) {
			var r = e.center, o = e.filterZoomEvent, n = e.onMoveStart, s = e.onMoveEnd, l = e.onMove, i = e.translateExtent, c = void 0 === i ? [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]] : i, f = e.scaleExtent, d = void 0 === f ? [1, 8] : f, p = e.zoom, m = void 0 === p ? 1 : p, y = t.useContext(x), g = y.width, v = y.height, b = y.projection, j = h(r, 2), M = j[0], E = j[1], k = h(t.useState({
				x: 0,
				y: 0,
				k: 1
