...
import { t as require_prop_types } from "./prop-types-oJSQWG5L.js";
...
//#endregion
//#region node_modules/react-dropzone/dist/index.js
...
var getInvalidTypeRejectionErr = (accept = "") => {
	...
	return {
		...
		message: `File type must be ${acceptArr.length > 1 ? `one of ${acceptArr.join(", ")}` : acceptArr[0]}`
	};
};
...
var Dropzone = (0, import_react.forwardRef)(({ children, ...params }, ref) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Fragment, { children: children({
		...props,
		open
	}) });
});
...
function useDropzone(props = {}) {
	...
	*/
	...
	const setFiles = (0, import_react.useCallback)((files, event) => {
		const acceptedFiles = [];
	...
	const getRootProps = (0, import_react.useMemo)(() => ({ refKey = "ref", role, onKeyDown, onFocus, onBlur, onClick, onDragEnter, onDragOver, onDragLeave, onDrop, ...rest } = {}) => ({
