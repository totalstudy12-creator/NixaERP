...
export function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (rememberMe) sessionStorage.setItem('login_email', trimmedEmail);
        ...
        {challenge ? (
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 backdrop-blur-sm">
            ...
            {error && (
              <div
                role="alert"
                className="mb-6 flex items-start gap-2 p-3 bg-rose-50 border border-rose-200 rounded-lg text-rose-700 text-sm animate-shake"
              >
