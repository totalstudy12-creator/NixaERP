...
/*
 * Legacy top-level auth aliases — kept for backward compatibility with
 * clients that call /api/login, /api/logout, /api/me, /api/profile.
 */
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    ...
    Route::prefix('mcp')->group(function () {
        ...
        Route::get('tokens', [SettingsController::class, 'listMcpTokens']);
        Route::post('tokens', [SettingsController::class, 'generateMcpToken']);
        Route::delete('tokens/{tokenId}', [SettingsController::class, 'revokeMcpToken']);
        Route::delete('tokens', [SettingsController::class, 'revokeAllMcpTokens']);
    });
    ...
    */
    ...
    Route::prefix('sales-returns')->group(function () {
        ...
        Route::get('/search/products', [SalesReturnController::class, 'searchProducts']);
        Route::get('/search/invoices', [SalesReturnController::class, 'searchInvoices']);
        Route::get('/search/customers', [SalesReturnController::class, 'searchCustomers']);

        Route::get('/customer/{customerId}/invoices', [SalesReturnController::class, 'getCustomerInvoices']);
        Route::get('/invoice/{invoiceId}/items', [SalesReturnController::class, 'getInvoiceItems']);
        Route::get('/invoice/{invoiceId}/details', [SalesReturnController::class, 'getInvoiceDetails']);
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Invoice Profitability (legacy alias)
    |--------------------------------------------------------------------------
    */
